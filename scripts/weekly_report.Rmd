---
title: "BirdNET-Pi Weekly Bird Report"
author: "Jos"
output:
  pdf_document:
    toc: false
...
```{r birdtable1, echo=FALSE, message = FALSE, warning = FALSE}
library(readr)
library(dplyr)
library(lubridate)
library(ggplot2)
...
```{r birdgraph1, echo=FALSE, message = FALSE, warning = FALSE}
...
## Number of detections per day part

```{r birdgraph2, echo=FALSE, message = FALSE, warning = FALSE}
...
```{r birdgraph3, echo=FALSE, message = FALSE, warning = FALSE}
...
```{r birdtable2, echo=FALSE, message = FALSE, warning = FALSE}
if (no_data) {
